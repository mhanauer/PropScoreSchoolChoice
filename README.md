...
my_lms = lapply(1:m, function(x) lm(S2REGSKL ~ X1PRNCON, data = a.out$imputations[[x]]))
# Below does not work either so need to grab coefficients maybe?  But I want summary stats as well
